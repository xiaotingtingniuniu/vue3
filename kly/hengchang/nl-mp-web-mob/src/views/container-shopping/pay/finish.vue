<template>
    <div class="pay-result-new" v-if="pageData">
        <div class="pay-result">
            <van-nav-bar v-if="opacity>=1" fixed z-index="10000" :style="{'background': `rgba(241, 101, 66, ${opacity})`}" :border="false">
            ...
            <div class="tip--success">
                ...
                <div class="pay-amount">支付金额：{{ (pageData.payAmount / 100).toFixed(2) }}</div>
