const routes = [{
    ...
    path: '/container-refund-progress/:refundNo/:orderNoSub',
    name: 'container-refund-progress',
    props: true,
    meta: {
        title: '退款进度'
    },
    component: () => import(/* webpackChunkName: "container-refund-progress" */ '@/views/container-shopping/refund/progress.vue')
}]
