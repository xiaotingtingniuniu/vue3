...
const tHead = [
    ...
    { align: 'center', tooltip: true, prop: 'skuId', label: 'Sku编号', minWidth: 180 },
...
const toDetail = (val, examine) => {
    router.push({ name: 'mall-goods-examine-manage-detail', params: { approvalCode: val.approvalCode, examine } })
}
