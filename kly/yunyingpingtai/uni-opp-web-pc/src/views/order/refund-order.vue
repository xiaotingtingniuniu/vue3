    ...
    <div class="work-order-container">
        <div class="search-area">
            <el-form ref="formRef" :model="searchData" :inline="true" label-position="right" label-width="100px">
                ...
                <el-form-item label="退款订单编号" prop="workNumber">
                    <el-input v-model="searchData.workNumber" placeholder="请输入～" clearable />
                </el-form-item>
                <el-form-item label="退款订单状态" prop="workStatus">
...
const radio = ref(3)
const tHead = [
    { align: 'center', tooltip: true, prop: 'orderNumber', label: '退款订单单号', minWidth: 200, fixed: true },
    { align: 'center', tooltip: true, prop: 'workNumber', label: '工单编号', minWidth: 200 },
    { align: 'center', tooltip: true, prop: 'mobile', label: '订单单号', minWidth: 100 },
    { align: 'center', tooltip: true, prop: 'gtmCreator', label: '商户订单单号', minWidth: 130 },
    { align: 'center', tooltip: true, prop: 'workEndTime', label: '退款订单状态', minWidth: 130 },
    { align: 'center', tooltip: true, prop: 'workStatus', label: '退款金额', minWidth: 100, slot: true }
]
const tableData = ref([])
