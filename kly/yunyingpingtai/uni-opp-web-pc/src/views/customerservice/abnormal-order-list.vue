    ...
    <div class="work-order-container">
        <div class="search-area">
            <el-form ref="formRef" :model="searchData" :inline="true" label-position="right" label-width="100px">
                ...
                <el-form-item label="异常类型" prop="exceptionLabel">
                    <el-select v-model="searchData.exceptionLabel" clearable placeholder="请选择" >
                        <el-option v-for="item in options1" :key="item.type" :label="item.desc" :value="item.type"/>
                    </el-select>
                </el-form-item>
                ...
                <!-- <el-form-item label="异常标签" prop="exceptionLabel">
                    <el-select v-model="searchData.exceptionLabel" clearable placeholder="请选择" >
                        <el-option
                            v-for="item in exceptionLabelList"
                            :key="item.type"
                            :label="item.desc"
                            :value="item.type"
                        />
                ...
                <!-- <el-form-item label="订单标签" prop="orderLevel">
                    <el-select v-model="searchData.orderLevel" clearable placeholder="请选择" >
                        <el-option
                ...
                <el-form-item label="异常订单创建时间" prop="createStartTime" class="form-item-time" label-width="150px">
        ...
        <div class="tableList-area">
            ...
            >
                ...
                <template #operation="scope">
                    <el-button type="primary" @click="toDetail(scope.row.workNumber, 1)" text>
                        查看
                    </el-button>
                </template>
            </system-list>
...
import { publicExport } from '@/api/common/index'
...
const tHead = [
    ...
    { align: 'center', tooltip: true, prop: 'exceptionLabels', label: '异常类型', minWidth: 100 },
    { align: 'center', tooltip: true, prop: 'workStatusName', label: '处理结果', minWidth: 100 },
    ...
    // { align: 'center', tooltip: true, prop: 'custAppealType', label: '支付方式', minWidth: 100 },
    ...
    { align: 'center', tooltip: true, prop: 'workType', label: '工单类型', minWidth: 120, slot: true },
...
const toDetail = (orderNo, iscon) => {
    // router.push({ name: 'abnormal-order-detail', params: { orderNo, iscon } })
    const routeData = router.resolve({ name: 'abnormal-order-detail', params: { orderNo, iscon } })
...
const exportList = async () => {
    ...
    publicExport({ key: 'CONTAINER_ABNORMAL_WOEK_LIST', body: params, exportName: '统一运营平台-货柜异常识别工单-' + getTimer() })
}
