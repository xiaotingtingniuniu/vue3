<template>
    <div class="work-order-container">
        ...
        <div class="gongdaninfo">
            <h2>工单信息</h2>
            <el-row :gutter="20">
                <el-col :span="8"><div class="height-p">订单编号：{{detail.orderNumber}}</div></el-col>
                <el-col :span="8"><div class="height-p">工单编号：{{detail.workNumber}}</div></el-col>
                <el-col :span="8"><div class="height-p">用户手机号：{{detail.mobile}}</div></el-col>
            </el-row>
            <el-row :gutter="20">
                <el-col :span="8"><div class="height-p">发起时间：{{detail.gtmCreator}}</div></el-col>
            ...
            <el-row :gutter="20">
                <el-col :span="8"><div class="height-p">工单类型：{{detail.workType === 0?'退款':'补款'}}</div></el-col>

                <el-col :span="8"><div class="height-p">客诉类型：{{workStatusList[detail.custAppealType]}}</div></el-col>
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <div class="height-p">
                        运单号：
                        <span>{{detail.courierNumber}}</span>
                    </div></el-col>
                <el-col :span="8">
                    <div class="height-p">
                        配送方式编码：
                        <span v-if="detail.deliveryMethod === 1">厂商直发</span>
                        <span v-if="detail.deliveryMethod === 2">仓库发后</span>
                    </div></el-col>
            </el-row>
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <div class="height-p">
                        订单状态：{{orderStatusList[detail.orderStatus]}}
                    </div></el-col>
            </el-row >
            ...
            <el-table :data="tableDataAudit" align="center" stripe  show-summary :summary-method="getSummaries"  :cell-style="changeCellStyle">
                ...
                <el-table-column prop="approvalNumedit" label="审核后商品退款数" align="center">
                    <template v-slot="scope" class="input-approval">
                        <el-input-number :precision="0" v-model="scope.row.approvalNumedit" controls-position="right" :min="0" :max="scope.row.num" placeholder="请输入～" @change="checknum(scope.row)" :disabled="detail.workStatus !== 0" style="color:red;width:auto"></el-input-number>
