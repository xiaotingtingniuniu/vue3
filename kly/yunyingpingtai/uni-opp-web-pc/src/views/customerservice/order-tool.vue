        ...
        <div class="search-area">
            <el-form ref="formRef" :model="searchData" :inline="true" label-position="right" label-width="100px">
                <el-form-item label="订单编号" prop="orderNo">
                    <el-input v-model.trim="searchData.orderNo" placeholder="请输入订单编号SO开头" clearable />
                </el-form-item>
                <el-form-item label="OA单号" prop="orderNo">
                    <el-input v-model.trim="searchData.orderNo" placeholder="请输入OA开头的工单号" clearable />
                </el-form-item>
                <el-form-item label="用户手机号" prop="orderNo">
                    <el-input v-model.trim="searchData.orderNo" placeholder="请输入用户手机号码" clearable />
                </el-form-item>
                <el-form-item label="用户ID" prop="orderNo">
                    <el-input v-model.trim="searchData.orderNo" placeholder="恒生活用户ID" clearable />
                </el-form-item>
...
const radio = ref(3)
const tHead = [
    { align: 'center', tooltip: true, prop: 'userId', label: '订单编号', minWidth: 200, fixed: true },
    { align: 'center', tooltip: true, prop: 'phoneMobile', label: 'OA单号', minWidth: 200 },
    { align: 'center', tooltip: true, prop: 'groupCode', label: '用户ID', minWidth: 100 },
    { align: 'center', tooltip: true, prop: 'groupName', label: '用户电话', minWidth: 130 },
    { align: 'center', tooltip: true, prop: 'couponCode', label: '商家类型', minWidth: 130 },
    { align: 'center', tooltip: true, prop: 'userCouponStatus', label: '商家编号', minWidth: 100 },
    { align: 'center', tooltip: true, prop: 'orderNo', label: '商家名称', minWidth: 100 },
    { align: 'center', tooltip: true, prop: 'businessCode', label: '设备编号', minWidth: 100 },
    { align: 'center', tooltip: true, prop: 'couponType', label: '设备名称', minWidth: 120 },
    { align: 'center', tooltip: true, prop: 'orderNo', label: '厂商', minWidth: 100 },
    { align: 'center', tooltip: true, prop: 'businessCode', label: '设备ID', minWidth: 100 },
    { align: 'center', tooltip: true, prop: 'couponType', label: '代运营商', minWidth: 120 },
    { align: 'center', tooltip: true, prop: 'couponType', label: '设备名称', minWidth: 120 },
    { align: 'center', tooltip: true, prop: 'orderNo', label: '订单应付总金额', minWidth: 100, slot: true },
    { align: 'center', tooltip: true, prop: 'businessCode', label: '订单实付金额', minWidth: 100, slot: true },
    { align: 'center', tooltip: true, prop: 'couponType', label: '订单优惠金额', minWidth: 120, slot: true },
    { align: 'center', tooltip: true, prop: 'orderNo', label: '申请设备开门时间', minWidth: 100 },
    { align: 'center', tooltip: true, prop: 'businessCode', label: '设备开门时间', minWidth: 100 },
    { align: 'center', tooltip: true, prop: 'couponType', label: '运营模式', minWidth: 120, slot: true },
    { align: 'center', tooltip: true, prop: 'couponType', label: '支付方式', minWidth: 120, slot: true },
...
const toDetail = async (handleType, info) => {
    router.push({ name: 'coupon-details', params: { handleType, groupCode: info && info.groupCode, subCode: info && info.businessCode === '1' ? 'A10010002' : info.businessCode === '2' ? 'A10010001' : info.businessCode === '3' ? 'A10010003' : 'A10010004', auditId: info && info.auditId } })
}
