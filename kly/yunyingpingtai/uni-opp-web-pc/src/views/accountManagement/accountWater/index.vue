        ...
        <el-card class="cardBox">
            ...
            >
                ...
                <template #transAmount="scope">
                    {{scope.row.transAmount === 0 ? 0 : ((scope.row.transAmount*0.01).toFixed(2))}}
                </template>
                <template #frozenAmount="scope">
                    {{scope.row.frozenAmount === 0 ? 0 : ((scope.row.frozenAmount*0.01).toFixed(2))}}
                </template>
                <template #resultAmount="scope">
                    {{scope.row.resultAmount === 0 ? 0 : ((scope.row.resultAmount*0.01).toFixed(2))}}
                </template>
            </system-list>
        </el-card>
    </div>
