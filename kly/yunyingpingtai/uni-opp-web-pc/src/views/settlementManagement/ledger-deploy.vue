        ...
        <el-card class="box-card">
            <div class="search-area">
                <el-form ref="formRef" :model="searchData" :inline="true" label-position="auto">
                    <el-form-item label="设备号" prop="userId">
                        <el-input v-model.trim="searchData.userId" />
                    </el-form-item>
                    <el-form-item label="商户号" prop="buyerUserId">
                        <el-input v-model.trim="searchData.buyerUserId"/>
                    </el-form-item>
                    <el-form-item label="状态" prop="userRoleType">
                    ...
                    <el-form-item label="分账方商户号" prop="userMobile">
                        <el-input v-model.trim="searchData.userMobile"/>
                    </el-form-item>
                    <el-form-item label="分账方/企业名称" prop="userMobile">
                        <el-input v-model.trim="searchData.userMobile"/>
                    </el-form-item>
                    <el-form-item label="渠道" prop="userRoleType">
                        <el-select v-model="searchData.userRoleType" clearable placeholder="请选择">
                            <el-option label="微信" value="1" />
                            <el-option label="支付宝" value="2" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="合作状态" prop="userRoleType">
                        <el-select v-model="searchData.userRoleType" clearable placeholder="请选择">
                            <el-option label="正常" value="1" />
                            <el-option label="中止" value="2" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="创建时间" prop="startTime" class="form-item-time">
                        <el-date-picker v-model="searchData.startTime" type="date" value-format="YYYY-MM-DD"  placeholder="开始时间" :editable="false"/>
                    </el-form-item>
                    <el-form-item label="业务线" prop="userRoleType">
                        <el-select v-model="searchData.userRoleType" clearable placeholder="请选择">
                            <el-option label="货柜业务" value="1" />
                            <el-option label="X平台" value="2" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="分账方类型" prop="userRoleType">
                        <el-select v-model="searchData.userRoleType" clearable placeholder="请选择">
...
const tHead = [
    { align: 'center', prop: 'userId', label: '业务线', minWidth: 150, fixed: 'left' },
    { align: 'center', prop: 'remark', label: '商户号', width: 80, fixed: 'left' },
    { align: 'center', prop: 'userMobile', label: '设备号', minWidth: 120 },
    { align: 'center', prop: 'userRoleType', label: '设备名称', minWidth: 120, slot: true },
    { align: 'center', prop: 'buyerUserId', label: '分账方类型', minWidth: 150 },
    { align: 'center', prop: 'outerOrderNo', label: '分账方/企业名称', minWidth: 180 },
    { align: 'center', prop: 'skuId', label: '分账方账号', minWidth: 150 },
    { align: 'center', prop: 'skuName', label: '分账人手机号', minWidth: 150 },
    { align: 'center', prop: 'cateRatio', label: '分账周期', slot: true },
    { align: 'center', prop: 'cmnTypeDesc', label: '渠道', minWidth: 120 },
    { align: 'center', prop: 'cmnTypeDesc', label: '分账比例', minWidth: 120 },
    { align: 'center', prop: 'cmnStartTime', label: '分账生效时间', minWidth: 170, slot: true },
    { align: 'center', prop: 'cmnStartTime', label: '分账失效时间', minWidth: 170, slot: true },
    { align: 'center', prop: 'cmnTypeDesc', label: '状态', minWidth: 120 },
    { align: 'center', prop: 'cmnTypeDesc', label: '合作状态', minWidth: 120 },
    { align: 'center', prop: 'cmnStartTime', label: '创建时间', minWidth: 170, slot: true },
    { align: 'center', prop: 'cmnStartTime', label: '修改时间', minWidth: 170, slot: true }
]
