        ...
        <el-card class="box-card">
            <div class="search-area">
                <el-form ref="formRef" :model="searchData" :inline="true" label-position="auto">
                    <el-form-item label="柜主ID" prop="userId">
                        <el-input v-model.trim="searchData.userId" />
                    </el-form-item>
                    <el-form-item label="柜主手机号" prop="buyerUserId">
                    ...
                    <el-form-item label="分账方手机号" prop="outerOrderNo">
...
const tHead = [
    { align: 'center', prop: 'userId', label: '柜主ID', minWidth: 150, fixed: 'left' },
    { align: 'center', prop: 'remark', label: '柜主姓名', width: 80, fixed: 'left' },
    { align: 'center', prop: 'userMobile', label: '柜主手机号', minWidth: 120 },
    { align: 'center', prop: 'userRoleType', label: '分账接收方类型', minWidth: 120, slot: true },
    { align: 'center', prop: 'buyerUserId', label: '分账方手机号', minWidth: 150 },
    { align: 'center', prop: 'outerOrderNo', label: '分账方/企业名称', minWidth: 180 },
    { align: 'center', prop: 'skuId', label: '分账方openid/商户名', minWidth: 150 },
    { align: 'center', prop: 'skuName', label: '渠道', minWidth: 150 },
    { align: 'center', prop: 'cateRatio', label: '状态', slot: true },
    { align: 'center', prop: 'cmnTypeDesc', label: '配置时间', minWidth: 120 },
