                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="品牌" prop="brandCode">
                            <el-select v-model.trim="searchData.brandCode" clearable placeholder="请选择" >
...
const edit = (merchantCode, goodsId) => {
    router.push({ name: 'add-goods', params: { merchantCode, goodsId } })
}
...
const getGoodsList = async () => {
    const params = {
        body: {
            ...
            currPage: dataState.pageinfo.currPage,
        ...
        appKey: 'A1001000',
        busiCode: 'A1001001',
        configCode: 'UC1657692254287AsbfH',
        name: 'Goods分页列表查询',
        source: '商品中台',
