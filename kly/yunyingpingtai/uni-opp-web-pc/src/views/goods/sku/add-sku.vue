...
const getSkuDetails = async () => {
    ...
    ruleForm.value.cateName = res.firstCateName ? res.firstCateName + '/' + res.secondCateName + '/' + res.thirdCateName + '/' + res.fourthCateName : res.secondCateName + '/' + res.thirdCateName + '/' + res.fourthCateName
...
const modify = async () => {
    // 修改更新发起的请求
    // !cateNameTextList.value.length && applyClassifyChange()
    // !limitedRegionList.value.length && skuAreaChange()
    applyClassifyChange()
    skuAreaChange()
    const parm = {
        body: {
            ...
            // busiCates: cateNameTextList.value.length ? cateNameTextList.value : [
            //     {
            //         busiFirstCateCode: cateNameTextList.value[0]?.firstCateCode,
            //         busiFirstCateName: cateNameTextList.value[0]?.firstCateName,
            //         busiSecondCateCode: cateNameTextList.value[0]?.secondCateCode,
            //         busiSecondCateName: cateNameTextList.value[0]?.secondCateName,
            //         busiThirdCateCode: cateNameTextList.value[0]?.busiThirdCateCode,
            //         busiThirdCateName: cateNameTextList.value[0]?.busiThirdCateName
            //     }
            // ],
