<template>
    <div class="information-management">
        ...
        <el-form :model="form" label-width="150px"  ref="ruleFormRef">
            ...
            <el-form-item label="" v-if="props.handleType==='add' || props.handleType==='detailnew' || props.handleType==='editnew'">
                <el-button type="primary" plain @click="prveStep">上一步</el-button>
                <el-button type="primary" v-if="props.handleType==='detailnew'" @click="submitMerchant(0)">保存</el-button>
                <el-button type="primary" @click="submitMerchant(1)">下一步</el-button>
            </el-form-item>
            <el-form-item label="" v-if="props.handleType==='edit'||props.handleType==='detail'">
                <el-button type="primary" plain @click="prveStep">上一步</el-button>
                <el-button type="primary" v-if="props.handleType==='edit'" @click="submitMerchant(0)">保存</el-button>
                <el-button type="primary" @click="submitMerchant(1)">下一步</el-button>
            </el-form-item>
        </el-form>
    </div>
...
const submitMerchant = async (type) => {
    ...
    } else if (props.handleType === 'detailnew' || props.handleType === 'detail') {
        router.push({ name: 'submit-apply', params: { handleType: props.handleType } })
    } else {
        router.push({ name: 'submit-apply', params: { handleType: 'add' } })
    }
...
const submitMerchant1 = () => {
    ...
    const param = {
        body: {
            appKey: 'A1001000',
            busiCode: dataState.form.busiCode,
            merchantId: addMerchant.merchantId || addMerchant.newMerchantId,
            merchantType: addMerchant.merchantType + '',
            isCheckParam: 1,
            busiMerchantId: addMerchant.busiMerchantId || addMerchant.newbusiMerchantId,
            promoCode: dataState.form.roleCode,
