<template>
    <div class="information-management">
            ...
            <div v-for="item in form.merchantCertUrlList" :key="item.certName">
                <el-form-item :label="item.certName" prop="permitImg">
                    ...
                    <cst-upload
                        :limit="3"
                        :multiple="false"
                        v-model:fileList="item.imgUrl"
                        accept=".jpg,.png,.jpeg"
                        :mediaType="1"
                        :disabled="noCan || noCanNew"
                        @handleAvatarSuccess="fn"
                    ></cst-upload>
                </el-form-item>
        ...
        <!-- 修改手机号弹窗 -->
        <el-dialog v-model="dataState.editorPhoneNumDialog" width="35%" center :show-close="false">
        ...
        <!-- 验证码弹窗 -->
        <el-dialog v-model="dataState.phoneVerCodeDialog" width="35%" center :show-close="false">
            <!-- <template #title>
        ...
        <!-- 协议弹窗 -->
        <el-dialog v-model="dataState.agreementDialog" width="50%" center :close-on-click-modal="false" :show-close="false">
        ...
        <!-- 引导弹窗 -->
        <el-dialog v-model="dataState.downloadDialog" width="50%" center :close-on-click-modal="false" :show-close="false">
