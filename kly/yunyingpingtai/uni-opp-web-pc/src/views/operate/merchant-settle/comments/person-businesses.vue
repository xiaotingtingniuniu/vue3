    ...
    <div class="basic-container">
        ...
        <el-form :model="form" label-width="150px" ref="ruleFormRef" :rules="rules" :disabled="noCan || noCanNew || isAllowEdit === false">
            ...
            <el-row>
                <el-col :span="8">
                    <el-form-item label="营业执照：" prop="businessLicenseUrl">
                        <cst-upload :limit="1" :multiple="false" v-model:fileList="form.businessLicenseUrl" accept=".jpg,.png,.jpeg" :mediaType="2" :disabled="noCan || noCanNew" @delete="uploadDel" />
                    </el-form-item>
                </el-col>
            </el-row>
            <div class="title">
            ...
            <el-row>
                <el-col :span="8">
                    <el-form-item label="账户类型：" prop="batchName">
                        <el-radio-group v-model="form.bindType" class="ml-4">
            ...
            <el-row>
                ...
                <el-col :span="8">
                    <el-form-item label=" 开户银行支行:" prop="bankPhone">
...
const apply = async (idNo) => {
    ...
    if (res.code === '200') {
        form.bankAcc = res.data.bankName
    }
}
const prev = () => {
...
const reverseSequence = async () => {
    ...
    if (res) {
        ...
        form.businessLicenseType = res?.businessLicenseType !== null ? res?.businessLicenseType + '' : ''
        ...
        // form.organizationLicenseUrl = res.organizationLicenseUrl[0]?.url,
...
const handleAvatarSuccess3 = async (data) => {
    ...
    if (ocrData?.code === '200') {
        ...
        form.validBeginTime = ocrData.data.idIssueDate
        form.validEndTime = ocrData.data.idExpiryDate
    }
