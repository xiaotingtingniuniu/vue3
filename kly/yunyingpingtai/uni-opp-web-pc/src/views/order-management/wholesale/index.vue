...
const quotationDetailed = (row) => {
    const routeData = router.resolve({ name: 'wholesale-order-detail', params: { orderNoSub: row.orderNoSub } })
    window.open(routeData.href, '_blank')
    // router.push({ name: 'wholesale-order-detail', params: { orderNoSub: row.orderNoSub } })
}
...
const exportExcel = async () => {
    const params = {
        ...
        appKey: 'A1001001',
        busiCode: 'A1001001',
        exportName: '统一运营平台-批发订单-' + generateDate(),
