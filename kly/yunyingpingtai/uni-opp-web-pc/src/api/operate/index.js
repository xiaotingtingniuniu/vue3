...
// 返回代取code
export async function getMerchantListCodes (params) {
...
export const replenishmentAllList = (param) => {
    const params = Object.assign({
        ...
        // configCode: 'UC18265613169979392',
        configCode: 'UCJH75649056666820608',
        name: '分页查询补货单',
        source: '运单中台',
        body: param
    })
...
export const replenishmentkDetail = (param) => {
    const params = Object.assign({
        appKey: 'A1001000', // 系统编号
        busiCode: 'A1001000', // 业务线编号
        configCode: 'UC18268554379522048',
        name: '补货单详情',
        source: '运单中台',
        body: param
    })
...
// 供应链库存
export const equipmentAllList = (param) => {
    const params = Object.assign({
        appKey: 'A1001000', // 系统编号
        busiCode: 'A1001000', // 业务线编号
