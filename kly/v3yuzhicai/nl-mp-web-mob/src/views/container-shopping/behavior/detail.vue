    ...
    <div class="container-behavior-detail-page status-bar-height">
        ...
        <div class="cell-group">
            <div class="card">
                ...
                <div class="cell">
                    ...
                    <div class="content">{{ deviceAddress }}</div>
                </div>
            </div>
        </div>
        <div class="cell-group">
            <div class="card" v-if="Number(props.status)===2">
                ...
                <div class="cell">
                    ...
                    <div class="content-box">
                        ...
                        <div class="copy-bader" @click="copyCode(orderNo)">复制</div>
                    </div>
                </div>
                <div class="cell">
            ...
            <div class="card" v-else>
                <div class="group-title van-hairline--bottom">行为信息</div>
                <div class="cell">
        ...
        <template v-if="orderStatus === 2">
            <div class="button is-app">
                <van-button @click="showServiceActionSheet" round color="#F16642">联系客服</van-button>
            </div>
