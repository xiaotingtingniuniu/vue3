        ...
        <div class="main-container">
            <div class="center">
                ...
                <div class="form">
                    ...
                    <p class="form-tip"><span class="check" :class="checkClass" @click="checkChange"></span>我已阅读并接受 <router-link to="agreement-privacy">《用户隐私协议》</router-link><router-link to="agreement-service">《用户服务协议》</router-link></p>
                </div>
            </div>
            <div class="introduce">
            ...
            <div class="introduce last-introduce">
                ...
                <ul class="text-container">
                    <li class="introduce-text">1.填写手机号注册，注册成功后优惠券将发放至恒生活APP</li>
                    <li class="introduce-text">2.下载并打开恒生活APP，点击“我的”-“优惠券”，可查看到账优惠券，优惠券可直接抵扣店内支付金额</li>
                    <li class="introduce-text">3.打开恒生活APP，点击“我的”-“到店支付”，扫描店内支付二维码，然后输入支付金额完成支付</li>
                </ul>
            </div>
...
const fictitious = ['162', '165', '167', '170', '171']
...
// 获取验证码
const getCode = async () => {
    console.log(typeof dataState.mobile)
    ...
    if (fictitious.includes(dataState.mobile.slice(0, 3))) {
        Toast('请输入真实有效的手机号！')
        return
    }
