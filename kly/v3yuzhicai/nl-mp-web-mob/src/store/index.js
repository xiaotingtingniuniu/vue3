...
const store = createStore({
    state: {
        ...
        appDialog: {
            ...
            right: null,
            close: null,
            leftClick: () => store.commit('setAppDialog', { visible: false }),
            rightClick: () => store.commit('setAppDialog', { visible: false }),
            closeClick: () => store.commit('setAppDialog', { visible: false })
        }
    },
    mutations: {
        setAppDialog (state, payload) {
            ...
            Object.assign(state.appDialog, payload)
        },
