<template>
    <div class="goods-item--3">
        ...
        <div class="goods-item--3-content">
            ...
            <div class="price">
                <div class="black">
                    <span class="unit">¥</span><span class="font-din">{{ (goodsInfo.realPrice / 100).toFixed(2) }}</span> <span><van-icon name="cross" /><span class="count">{{goodsInfo.quantity}}</span></span>
                </div>
                <div class="colour">
                    <div class="unit">¥</div>
                    <div class="font-din">{{((goodsInfo.realPrice / 100).toFixed(2) * goodsInfo.quantity).toFixed(2)}}</div>
                </div>
            </div>
        </div>
    </div>
